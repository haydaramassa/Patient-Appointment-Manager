...
public class RegisterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Personal Angaben / Registrierung");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--------", "Administrator", "Sekretärin" }));
    ...
    if (name.isEmpty() || email.isEmpty() || password.isEmpty() || role.equals("--------")) {
        javax.swing.JOptionPane.showMessageDialog(this, "Bitte alle Felder ausfüllen!");
        return;
    }
    ...
    try (java.sql.Connection conn = DBConnection.getConnection()) {
        ...
        javax.swing.JOptionPane.showMessageDialog(this, "Registrierung erfolgreich!");
        this.dispose(); // نغلق نافذة التسجيل بعد النجاح
